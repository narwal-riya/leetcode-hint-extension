// Prevent injection if already present on the page
if (document.getElementById('leet-hint-btn')) {
  console.log('[LeetHint] Button already exists. Skipping...');
} else {
  (function initExtension() {
    ...
    function detectProblemTopic() {
      ...
      for (const topic of Object.keys(hints)) {
        if (tags.some(tag => tag.includes(topic))) {
          return topic;
        }
      }
      return "general";
